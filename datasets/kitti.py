...
class KITTIDataset(Dataset):
    def __init__(self, config, kitti_root, split='train', editions='mixed', parts='mixed', crop=None, resize=None, samples = None):
        ...
        kitti_2015_flow_occ = os.path.join(kitti_root, r'data_scene_flow/training/flow_occ')
        kitti_path = dict()
        ...
        kitti_path['2012' + 'testing'] = os.path.join(kitti_root, r'data_stereo_flow/testing/colored_0')
        kitti_path['2015' + 'testing'] = os.path.join(kitti_root, r'data_scene_flow/testing/image_2')
